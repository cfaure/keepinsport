...
namespace Ks\ImageBundle\Classes;
...
class UploadHandler
{
    ...
    function __construct($options=null, $script = null) {
        ...
        $this->options = array(
           ...
           //'upload_dir' => $_SERVER['DOCUMENT_ROOT'] ."/web/uploads/activities/",
            ...
            'image_versions' => array(
                ...
                */
                /*'thumbnail' => array(
                    'upload_dir' => dirname($_SERVER['SCRIPT_FILENAME']).'/test2/',
                    //'upload_dir' => $_SERVER['DOCUMENT_ROOT'] . "/web/uploads/activities/test",
