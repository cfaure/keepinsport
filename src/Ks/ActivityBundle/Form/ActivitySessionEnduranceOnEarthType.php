...
class ActivitySessionEnduranceOnEarthType extends AbstractType
{   
    private $sport;
    private $user;
    private $club;

    public function __construct(\Ks\ActivityBundle\Entity\Sport $sport, \Ks\UserBundle\Entity\User $user)
    {
        $this->sport = $sport;
        $this->user = $user;
        $this->club = null;
    ...
    {
        return 'ksActivity_activitySessionEnduranceOnEarthType';
    }
    ...
    {
        return array(
            'data_class' => 'Ks\ActivityBundle\Entity\ActivitySessionEnduranceOnEarth'
        );
    }
