...
class NikePlusPHP {
	...
	private function _login($username, $password) {
		...
		$this->userId = isset( $this->loginCookies->serviceResponse->body->User ) ? $this->loginCookies->serviceResponse->body->User->screenName : null;
		$this->allTime();
	}
	...
	public function activities($limit = 0, $checkTotal = false) {
		...
		if(!$this->activities) {
			while($loop == true) {
				...
				//$results = $this->_getNikePlusFile('http://nikeplus.nike.com/plus/activity/running/2174095687/lifetime/activities');
                //var_dump($results);
