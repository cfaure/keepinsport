...
function YearView(element, calendar) {
	...
	function render(date, delta) {
		...
		colAndRow = '4x3'; //'2x6', '3x4', '4x3' 3 types
...
function AgendaView(element, calendar, viewName) {
	...
	function buildSkeleton() {
		...
		s =
			...
			"<tr>" +
			//FMO : display:none
                        "<th id='gutter1' style='' class='fc-agenda-axis " + headerClass + "'></th>";
                for (i=0; i<colCnt; i++) {
			s +=
		...
		s +=
			...
			"<tr>" +
			//FMO : display:none
                        "<th id='gutter2' style='' class='fc-agenda-axis " + headerClass + "'></th>";
		for (i=0; i<colCnt; i++) {
			s +=
...
function DayEventRenderer() {
	...
	function daySegHTML(segs) { // also sets seg.left and seg.outerWidth
		...
		for (i=0; i<segCnt; i++) {
			...
			html +=
				" class='" + classes.join(' ') + "'" +
				//FMO " style='position:absolute;z-index:8;left:"+left+"px;" + skinCss + "'" +
                                " style='border-width:2px;position:absolute;z-index:8;left:"+left+"px;" + skinCss + "'" +
				">" +
				"<div" +
			...
			html +=
				//FMO "<span class='fc-event-title'>" + htmlEscape(event.title) + "</span>" +
                                "<center><span class='fc-event-title'>" + /*htmlEscape(event.title) + */"</span></center>" +
				"</div>";
			if (seg.isEnd && isEventResizable(event)) {
				html +=
